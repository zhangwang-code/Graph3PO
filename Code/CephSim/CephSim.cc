...
main (int argc, char *argv[])
{
  ...
  CreateWorkLoad("scratch/CephSim/workload.csv");
  sleep(100);
  #endif
  ...
  for(int i = 0;i<RUN_NUM;++i)
  {
      ...
      // sprintf(clusterfilename_buf,"scratch/CephSim/cluster_map/%05d_cluster_map.csv",rad);
      ...
      // // string clusterfile("scratch/CephSim/60068_cluster_map.csv");

      string clusterfile("scratch/CephSim/cluster_map_mod.csv");
